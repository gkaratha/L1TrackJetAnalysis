...
#
#  The distributions compared are two unit Gaussians, where one is then modified, and
#  the sensitivity of each test is considered.
#
#  References:
#    Barlow: 
...
for iexp in range (Nexp) :
    ...
    # Make empty arrays, lists, and sums:
    ...
    pKS = TMath.KolmogorovTest(Nevents, x_gaussA_array, Nevents, x_gaussB_array, "D")
    ...
    if (Nexp > 1) :
        ...
        Hist_gaussA.Draw("e")           # Option "e" means "with errors (Poisson, i.e. sqrt(N))"
        
        Hist_gaussB.SetLineWidth(2)
        Hist_gaussB.SetLineColor(4)
        Hist_gaussB.Draw("e same")
